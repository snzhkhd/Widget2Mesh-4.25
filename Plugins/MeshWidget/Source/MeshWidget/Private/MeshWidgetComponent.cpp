	...
	, TickWhenOffscreen(false)
{
	...
	SetRelativeRotation(FRotator::ZeroRotator,false, nullptr, ETeleportType::None);
...
//	rt = RenderTarget;
	...
	WidgetRenderer->DrawWindow(RenderTarget, HitTestGrid.ToSharedRef().Get(), SlateWindow.ToSharedRef(),DrawScale,CurrentDrawSize,DeltaTime, false);
	
//		WidgetRenderer->DrawWindow(Cast< FRenderTarget >(RenderTarget), HitTestGrid.ToSharedRef(), SlateWindow.ToSharedRef(), DrawScale, CurrentDrawSize, DeltaTime, false);
