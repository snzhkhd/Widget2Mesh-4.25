...
UCLASS(Blueprintable, hidecategories=(Object,Activation,"Components|Activation",Sockets,Base,Lighting,LOD,Mesh), editinlinenew, ClassGroup = Experimental, meta=(BlueprintSpawnableComponent))
...
protected:
	...
	/** The slate window that contains the user widget content			SWindow					 */
